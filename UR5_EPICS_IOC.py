...
class UR5RobotIOC(PVGroup):
    ...
    SampleToMount = pvproperty(value='Did that just work', dtype=ChannelType.STRING, string_encoding='latin-1')
    CurrentSample = pvproperty(value='I dont know what I did', dtype=ChannelType.STRING, string_encoding='latin-1')

    #puck_spec = PVSpec(value='PuckName,0', dtype=str, doc="Puck and Pin selection, format 'PuckName,PinNumber'")
